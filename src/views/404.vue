...
<template>
	<div class="min-h-screen center flex-col md:text-8xl text-6xl  font-extrabold">
		<h1>404</h1>
...
@keyframes asdd {
    0% {
        text-shadow: 0 0 30px rgba(0, 0, 0, 1.5);
    }
    33% {
        text-shadow: 0 0 10px rgba(0, 0, 0, 1.4);
    }
    66% {
        text-shadow: 0 0 20px rgba(0, 0, 0, 1.7);
    }
    100% {
        text-shadow: 0 0 40px rgba(0, 0, 0, 1.8);
    }
}
</style>